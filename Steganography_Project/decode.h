...
/* Encode the file extrn size  a byte into LSB of image data array */
...
// Status decode_image_to_data(const char *data, int size, FILE *fptr_src_image, FILE *fptr_stego_image);

/* Encode a byte into LSB of image data array */
Status decode_byte_from_lsb(char *ch, char *buffer);

/*closing the opening files for decoding*/
